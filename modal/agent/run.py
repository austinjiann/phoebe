"""Remote smoke runner used before OpenCode is wired in.

This keeps the first Modal milestone narrow:
- clone the single configured repo
- run a couple of git commands
- return structured output to the backend
"""
